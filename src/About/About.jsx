...
export function About () {
    return (
        <div className='about'>
            ...
            <p>
                Desde 1986 que o foco está em bem servir. Apostámos numa seleção rigorosa das nossas carnes
                e na Segurança alimentar.  
            </p>
            <p>
                Visite-nos e comprove você mesmo que os nossos produtos se distinguem do mercado local.
            </p>
        </div>
    );
}